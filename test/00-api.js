...
test("input type check", function (t) {
  t.throws(function () {
    nacl.secretbox(arr, nonce, key);
  }, TypeError);
  t.throws(function () {
    nacl.secretbox(msg, arr, key);
  }, TypeError);
  t.throws(function () {
    nacl.secretbox(msg, nonce, arr);
  }, TypeError);
  ...
  t.throws(function () {
    nacl.secretbox.open(msg, arr, key);
  }, TypeError);
  t.throws(function () {
    nacl.secretbox.open(msg, nonce, arr);
  }, TypeError);
  ...
  t.throws(function () {
    nacl.box.after(msg, arr, key);
  }, TypeError);
  t.throws(function () {
    nacl.box.after(msg, nonce, arr);
  }, TypeError);

  t.throws(function () {
    nacl.box.open.after(arr, nonce, key);
  }, TypeError);
  t.throws(function () {
    nacl.box.open.after(msg, arr, key);
  }, TypeError);
  t.throws(function () {
